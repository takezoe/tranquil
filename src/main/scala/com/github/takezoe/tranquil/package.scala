...
package object tranquil {
  ...
  // Type binders for supported data types
  ...
  // Implicit conversion to make DSL
  ...
  // Type aliases for tables which are generated by query
  ...
  // TableShapes for TableDef and ColumnX
  ...
  // Implicit conversion to TableShape
  ...
  // Define default values for each type
